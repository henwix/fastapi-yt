...
from app.application.subscriptions.queries import GetSubscriptionsQuery, GetSubscriptionsSortFieldsEnum
...
class GetSubscriptionsUseCase:
    ...
    async def execute(self, query: GetSubscriptionsQuery) -> tuple[list[DetailedSubscriptionDTO], dict | None]:
            ...
            if query.pagination.cursor is not Empty.UNSET:
                try:
                    ...
                    match query.sorting.sort_by:
                        case GetSubscriptionsSortFieldsEnum.created_at:
        ...
        if subscriptions and len(subscriptions) > query.pagination.per_page:
