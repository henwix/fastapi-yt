...
class TaskiqTaskQueue(ITaskQueue):
    ...
    async def send_channel_activation_code(
        ...
        await send_channel_activation_code_task.kiq(recipients=recipients, template_context=template_context)
    ...
    async def send_channel_set_email_code(
        ...
        await send_channel_set_email_code_task.kiq(recipients=recipients, template_context=template_context)
    ...
    async def send_channel_reset_password_code(
        ...
        await send_channel_reset_password_code_task.kiq(recipients=recipients, template_context=template_context)
